...
export class Web3Service {
  ...
  private contractAddress = '0x25bea48BBCa3d8febFfbE4DfB62f2C934f2aC6C1';
  ...
  //executeTransactions("vote" ,pollId , vote)
  //executeTransactions("createPoll",question,thumb,opt)
